...
const pages = [ 'Logins','Usuarios', 'Clientes','Productos','Cotizaciones','DetalleCotizacion'];
...
function ResponsiveAppBar() {
  ...
  const handleMenu = (typeSetting) => {//typeStting es la variable
    if(typeSetting==='Cerrar Sesión'){
      logout();
    }
  };
  //hacer funcion para el logout
  const logout = ()=>{
    dispatch(fetchLogout());//dispach es el disparador que se ejecuta
  }
  return (
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
                ...
                {/* { <MenuItem key={'h'} onClick={handleCloseUserMenu}>
